...
resource "aws_lambda_function" "my_lambda_function" {
    ...
    environment {
        variables = {
            "BUCKET_PATH" = "inbound-bucket-custom/incoming/"
        }
    }
}
    ...
    "Statement": [
        {
            ...
            "Resource": "arn:aws:s3:::inbound-bucket-custom/*"
        },
        {
            "Effect": "Allow",
            "Action": [
...
resource "aws_lambda_permission" "allow_s3_to_invoke_lambda" {
  ...
  source_arn    = "arn:aws:s3:::inbound-bucket-custom"
}
